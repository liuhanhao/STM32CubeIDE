...
![画板](https://cdn.nlark.com/yuque/0/2025/jpeg/42958080/1757147356606-79b472f3-4222-4030-9c85-8de11a61f552.jpeg)
...
| | <img src="https://cdn.nlark.com/yuque/0/2024/png/804193/1722850423034-ddfb2dcb-fd99-4eb0-baf6-4d48840797a1.png?x-oss-process=image%2Fwatermark%2Ctype_d3F5LW1pY3JvaGVp%2Csize_18%2Ctext_eWluZXJkYQ%3D%3D%2Ccolor_FFFFFF%2Cshadow_50%2Ct_80%2Cg_se%2Cx_10%2Cy_10" width="616" title="" crop="0,0,1,1" id="ua67c5022" class="ne-image"> | |
...
| 12 | 设置HTTP参数连接，支持IP和域名。<br/>浏览器打开[http://test.yinerda.com](http://test.yinerda.com)，选择“HTTP测试工具”，点击"打开"可以获取测试服务器信息<br/>注意如果请求有参数url后面要有?号，?号后面根据的请求参数。如果没有参数，就不需要问号<br/>测试平台可是设置服务器返回数据。 | |
|  | <img src="https://cdn.nlark.com/yuque/0/2026/png/42958080/1767952607005-e575a8ad-6313-493e-834c-a5932463764d.png?x-oss-process=image%2Fwatermark%2Ctype_d3F5LW1pY3JvaGVp%2Csize_46%2Ctext_eWluZXJkYQ%3D%3D%2Ccolor_FFFFFF%2Cshadow_50%2Ct_80%2Cg_se%2Cx_10%2Cy_10" width="1481.8181497006383" title="" crop="0,0,1,1" id="u1e9a49f7" class="ne-image"> | |
| 13 | 关闭HTTP，在关闭之前，之前的参数一直有效，关闭后需要重新初始化<br/>如果HTTP异常可以关闭，但是不必须。如果没关闭，后续只需要提交请求即可 | |
...
# 七、使用建议
可以用HTTP协议提交数据。注意HTTP的url数据要符合url-encode编码才行，需要自行编码后上传。
